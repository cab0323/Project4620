...
/**
 * DineInCustomer extends AbsCustomer to inherit its ID and Type DineInCustomer implements the
 * IDineInCustomer interface
 *
 * Correspondences: Table_Num = tableNum Seats = seats
 */
