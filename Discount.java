...
/*
 * This contains code for your discount object. You should not need to modify this, unless you use
 * the discount name as the primary key instead of adding an ID. Then you can remove the ID field
 * and methods
 * 
 * NOTE: Percent is stored as a decimal. If you store 20% as .20 in your database, then this is
 * fine. If you store 20% as 20 then you will want to make sure to divide the value by 100 when you
 * load it into the Discount object.
 * 
 * NOTE: If the discount is percent off, then pass 0.0 as cash_off to the constructor, and vice
 * versa.
 * 
 */
...
public class Discount {
   ...
   * @requires 0 <= p <= 1 0 <= c i = -1 || a valid ID in the database
   */
