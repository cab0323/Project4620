...
/*
 * Your topping class. It should not need modification unless you don't have an ID for your toppings
 * in your database
 */

/**
 * Topping contains the information such as the name, price, ID, inventory level, and whether or not
 * the customer selected "Extra" of that topping
 *
 * @invariants: ID is a valid ID price >= 0 inventory >= 0
 *
 */
...
public class Topping {
   ...
   * @requires i is a valid ID price >= 0 inventory >= 0
   *
   * @ensures name = n price = p inventory = inv ID = i extra = false
   */
  //HAVE TO MODIFY TOPPING DECLARATION SINCE I DO NOT USE A TOPPING ID
